...
"font: 75 12pt \"MS Shell Dlg 2\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Prediction of Citation Count"))
        self.pushButton.setText(_translate("MainWindow", "Physiology Set-2  Features"))
        self.pushButton_2.setText(_translate("MainWindow", ".csv creation"))
        self.pushButton_3.setText(_translate("MainWindow", "Support Vector Machine Classification"))
        self.pushButton_4.setText(_translate("MainWindow", "Deep Reinforcement Classification"))
        self.pushButton_5.setText(_translate("MainWindow", "Physiology Set-1 Features"))
